...
// }
  ...
  findFamily(){
    ...
    var actualFam = family.split('. ', 1)[0];
  ...
  checkFamilyOnWiki(family){
    ...
    this.http.get('https://en.wikipedia.org/w/api.php?origin=*&format=json&action=query&prop=extracts&redirects=1&titles=' + family).subscribe(
      result => {
